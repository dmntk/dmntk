  ...
  fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    match (day > 0, hour > 0, minute > 0, seconds > 0, nanoseconds > 0) {
      ...
      (true, true, true, true, false) => {
        write!(f, "{sign}P{day}DT{hour}H{minute}M{seconds}S")
      }
      ...
      (false, false, true, true, true) => {
        write!(f, "{sign}PT{minute}M{seconds}.{nanoseconds_str}S")
      }
      (false, true, false, false, true) => write!(f, "{sign}PT{hour}H0.{nanoseconds_str}S"),
      (false, true, false, true, true) => {
        write!(f, "{sign}PT{hour}H{seconds}.{nanoseconds_str}S")
      }
      (false, true, true, false, true) => {
        write!(f, "{sign}PT{hour}H{minute}M0.{nanoseconds_str}S")
      }
      (false, true, true, true, true) => {
        write!(f, "{sign}PT{hour}H{minute}M{seconds}.{nanoseconds_str}S")
      }
      (true, false, false, false, true) => write!(f, "{sign}P{day}DT0.{nanoseconds_str}S"),
      (true, false, false, true, true) => {
        write!(f, "{sign}P{day}DT{seconds}.{nanoseconds_str}S")
      }
      (true, false, true, false, true) => {
        write!(f, "{sign}P{day}DT{minute}M0.{nanoseconds_str}S")
      }
      (true, false, true, true, true) => {
        write!(f, "{sign}P{day}DT{minute}M{seconds}.{nanoseconds_str}S")
      }
      (true, true, false, false, true) => {
        write!(f, "{sign}P{day}DT{hour}H0.{nanoseconds_str}S",)
      }
      (true, true, false, true, true) => {
        write!(f, "{sign}P{day}DT{hour}H{seconds}.{nanoseconds_str}S")
      }
      (true, true, true, false, true) => {
        write!(f, "{sign}P{day}DT{hour}H{minute}M0.{nanoseconds_str}S")
      }
